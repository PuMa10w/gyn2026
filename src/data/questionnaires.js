...
const rawQuestionnaires = [
  ...
  },
  {
    ...
    scoring: (answers) => {
      const total = answers.reduce((a, b) => a + b, 0);
      if (total <= 4) return { level: "Минимальная тревога", severity: "normal", color: "#B9DCC7", recommendation: "Наблюдение. Специфическое лечение не требуется." };
  ...
  },
  {
    ...
    scoring: (answers) => {
      ...
      if (maxDescent < 1) return { level: "Нет пролапса", severity: "normal", color: "#B9DCC7", recommendation: "Наблюдение. Упражнения Кегеля." };
  ...
  },
  {
    ...
    scoring: (answers) => {
      ...
      if (score <= 2) return { level: "Слабая боль", severity: "normal", color: "#B9DCC7", recommendation: "Наблюдение. НПВС при необходимости." };
  ...
  },
  {
    ...
    scoring: (answers) => {
      ...
      if (total <= 20) return { level: "Высокая удовлетворённость", severity: "normal", color: "#B9DCC7", recommendation: "Норма." };
      return { level: "Очень высокая удовлетворённость", severity: "normal", color: "#B9DCC7", recommendation: "Отлично." };
    }
  },
  {
    id: "kmi",
    ...
    scoring: (answers) => {
      const total = answers.reduce((a, b) => a + b, 0);
      if (total <= 4) return { level: "Нет дисменореи", severity: "normal", color: "#B9DCC7", recommendation: "Наблюдение." };
