  ...
  switch (cluster) {
    ...
    case 'postpartum':
      return [
        ...
        'УЗИ молочных жеР»РµР· при подозрении на лактостаз, мастит или абсцесс.',
...
const buildGynecologyImaging = (cluster: GynecologyCluster) => {
  switch (cluster) {
    ...
    case 'breast':
      return [
        'УЗИ молочных жеР»РµР· с оценкой формы, контуров, эхоструктуры и подмышечных лимфоузлов.',
        'Маммография или томосинтез по возрасту и онкориску.',
        'МРТ молочных жеР»РµР· при высокой плотности ткани, генетическом риске или неясной картине.',
      ];
    case 'menopause':
      return [
  ...
  switch (cluster) {
    case 'oncology':
      return {
        ...
        duration: 'Не менее 5 лет, РґР°Р»РµРµ индивидуально',
    ...
    case 'menopause':
      return {
        frequency: 'Через 3 месяца после старта терапии, РґР°Р»РµРµ обычно каждые 6-12 месяцев',
        duration: 'На протяжении периода симптомов и приема терапии',
        tests: ['Оценка симптомов и переносимости терапии', 'ТВУЗИ при кровянистых выделениях или факторах риска', 'Контроль молочных жеР»РµР·, костной ткани и метаболического профиля'],
      };
    default:
      return {
        frequency: 'Через 1-3 месяца после начала лечения, РґР°Р»РµРµ каждые 6-12 месяцев',
